...
import makeSelectCyientSurvey from './selectors';
import { submitCyientData } from './actions';
import CyientBanner from '../../../public/static/images/cyient.webp';
...
function CustomForm({ handleSubmitData, setOpenModal, leadsFrom }) {
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          {divPadding(
            <>
              ...
              <IntlTelInput
                ...
                inputClassName="otp_style_contact_amex otp_style_contact_cyient"
          ...
          <LocationContainer>
            <CustomInput
              ...
              margin="1rem 0"
              placeholder="City"
              // error={errors?.parentsDetails?.[index]?.city}
            />
...
export function CyientSurvey({ handleSubmitData }) {
        ...
        <HomePageBox>
          <HomePageBox
            ...
            <HomePageBox width={{ xs: '100%', md: '55%' }}>
              <HomePageImage src={CyientBanner} width="100%" height="100%" />
            </HomePageBox>
            <HomePageBox width={{ xs: '90%', md: '45%' }}>
              <HomePageText
                ...
                fontWeight={{ xs: '500', md: '500' }}>
                Cyient | Emoha Member Onboarding
              </HomePageText>
              <HomePageText
                color={{
                  xs: '#1A1A1A',
              ...
              <Formik
                ...
                validationSchema={cyientReviewSchema()}>
...
CyientSurvey.propTypes = {
  ...CyientSurvey,
};
CustomForm.propTypes = { ...CustomForm };

const mapStateToProps = createStructuredSelector({
  cyientSurvey: makeSelectCyientSurvey(),
});

function mapDispatchToProps(dispatch) {
  return {
    dispatch,
    handleSubmitData: (payload, callback) => dispatch(submitCyientData(payload, callback)),
  };
}

const withConnect = connect(mapStateToProps, mapDispatchToProps);

export default compose(withConnect, memo)(CyientSurvey);
