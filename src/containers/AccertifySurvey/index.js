...
import makeSelectAccertifySurvey from './selectors';
import { submitAccertifyData } from './actions';
...
export function AccertifySurvey({ pepsicoSurvey, handleSubmitData, heading, noOfElderOptedText, url }) {
          ...
          <HomePageBox
            ...
            <HomePageBox width={{ xs: '90%', md: '45%' }}>
              <HomePageText
                ...
                fontWeight={{ xs: '500', md: '500' }}>
                {heading || 'Accertify'} | Emoha Member Onboarding
              </HomePageText>
              <HomePageText
                color={{
                  xs: '#1A1A1A',
...
const mapStateToProps = createStructuredSelector({
  accertifySurvey: makeSelectAccertifySurvey(),
});

function mapDispatchToProps(dispatch) {
  return {
    dispatch,
    handleSubmitData: (payload, callback) => dispatch(submitAccertifyData(payload, callback)),
  };
}

const withConnect = connect(mapStateToProps, mapDispatchToProps);

export default compose(withConnect, memo)(AccertifySurvey);
