...
import makeSelectPepsicoSurvey from './selectors';
import { submitPepsicoData } from './actions';
      ...
      {divPadding(
        <>
          ...
          <CustomSelect
            ...
            inputProps={{ 'aria-label': 'With label' }}
            displayEmpty>
            {map(new Array(isEqual(heading, 'Google') ? 2 : 4), (item, key) => (
...
export function PepsicoSurvey({ pepsicoSurvey, handleSubmitData, heading, noOfElderOptedText, url }) {
          ...
          <HomePageBox
            ...
            <HomePageBox width={{ xs: '90%', md: '45%' }}>
              <HomePageText
                ...
                fontWeight={{ xs: '500', md: '500' }}>
                {heading || 'Pepsico'} | Emoha Member Onboarding
              </HomePageText>
              <HomePageText
                color={{
                  xs: '#1A1A1A',
...
export default compose(withConnect, memo)(PepsicoSurvey);
