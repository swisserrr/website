...
const ContactFormSection = styled(AboutUsSection)`
  ...
  z-index: 1;
  padding: 2.134rem 2.5rem 2.134rem 2.5rem !important;
...
const OfficeDetailContainer = styled(Grid)`
  ...
  position: relative; /* Helps maintain layout structure */
  padding-bottom: 20px; /* Adds spacing for expanded accordion */
  overflow: visible; /* Ensure the accordion expands properly */
...
const SubHeadingAddress = styled.div`
  color: #fff;
  font-size: 2.4rem;
  margin-bottom: 2rem;
  font-style: normal;
