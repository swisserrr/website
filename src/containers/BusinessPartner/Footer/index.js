...
function Footer({
  ...
  const [expanded, setExpanded] = useState('panel1-header'); // Track which Accordion is open

  const handleChangeAccordin = panel => (event, isExpanded) => {
    accordionRef.current?.scrollIntoView({ behavior: 'smooth', block: 'start' });
    setExpanded(isExpanded ? panel : false); // Only one panel can be expanded
  };
        ...
        {!hideFormSection && (
          <>
            {!fromApollo && !isPolicyBazaar && (
              <OfficeContactContainer item xl={4} lg={4} md={4} sm={12} xs={12} display={'flex'}>
                <ContactFormSection disableMargin={disableMargin} className="blur-background-white">
                  <HomePageText
                    variant={'h3'}
                    ...
                    {({ errors, values, handleChange, handleSubmit, setFieldValue }) => (
                      <Form
                        ...
                        {changeQuesTopConcern || fromVas ? (
                          ...
                          <IntlTelInput
                            containerClassName="intl-tel-input margin-top-bottom"
                            inputClassName={`${errors.phoneNumber ? 'error_style_form' : ''} custom_otp_style_home `}
                            ...
                            {businessPartnerChanges ? (
                              <>
                                ...
                                <CustomSelect
                                  ...
                                  className="contact-form margin-top-bottom"
                                  onChange={event =>
                                ...
                                {!isFromEnquire && (
                                  <>
                                    ...
                                    <CustomSelect
                                      ...
                                      displayEmpty
                                      style={{
                                        color: values.own_an_office_space_of_200_sqft_carpet_area
                                          ? '#2447ff'
                                          : '#d9d9d9',
                                        display: 'flex',
                                      }}
                            ...
                            <span style={{ display: 'flex', alignItems: 'center' }}>
                              <Image
                                ...
                                style={{
                                  ...
                                  width: matches ? '5rem' : '3.2rem',
                                  marginLeft: matches ? '0px' : '1rem',
                                  marginRight: '1rem',
                                }}
                                alt="Info Icon"
                              />
            ...
            <OfficeDetailContainer item xl={4} lg={4} md={4} sm={12} xs={12} display={'flex'}>
              <EmohaDetail>
                <SubHeadingAddress>CONTACT</SubHeadingAddress>
                <DetailContainer>
                  <CustomImage
                  ...
                  />
                  <a
                    href={fromApollo ? 'mailto:seniorsfirst@emoha.com' : 'mailto:feedback@emoha.com'}
                    target="_blank"
                    rel="noreferrer"
                    style={{ textDecoration: 'none' }}>
                    <DetailContainerText>
                      {fromApollo ? 'seniorsfirst@emoha.com' : bpEmail || 'eldersfirst@emoha.com'}
                    </DetailContainerText>
                  </a>
                </DetailContainer>
                <DetailContainer>
            ...
            <OfficeDetailContainer item xl={4} lg={4} md={4} sm={12} xs={12} display={'flex'}>
              <EmohaDetail>
                <SubHeadingAddress>OUR PRESENCE</SubHeadingAddress>
                <AccordionDiv
                  disableGutters
                  square
                  defaultExpanded
                  expanded={expanded === 'panel1-header'}
                  onChange={handleChangeAccordin('panel1-header')}
                  ref={accordionRef}
                  sx={{
                    '&:before': {
                      backgroundColor: '#DA7A7A', // Change this to the desired color
                    },
                  }}>
                  <AccordionSummaryDiv
                  ...
                  <AccordionDetailsDiv>
                    <DetailContainer>
                      ...
                      />
                      <a
                        href="http://maps.google.com/?q=216, Ocus Quantum Plaza, Sector 51, Opposite BPTP Freedom Park, Near Artemis Hospital Gurugram,
                  Haryana 122003"
                        style={{ color: '#ffffff', textDecoration: 'none' }}
                        target="_blank"
                        rel="noreferrer">
                        <DetailContainerText>
                          216, Ocus Quantum Plaza, Sector 51, Opposite BPTP Freedom Park, Near Artemis Hospital
                ...
                <AccordionDiv
                  ...
                  onChange={handleChangeAccordin('panel2-header')}
                  sx={{
                    '&:before': {
                      backgroundColor: '#DA7A7A', // Change this to the desired color
                    },
                  ...
                  <AccordionDetailsDiv>
                    <DetailContainer>
                      ...
                      />
                      <a
                        href="https://maps.app.goo.gl/SuZZW6shM4TptrSX9"
                        style={{ color: '#ffffff', textDecoration: 'none' }}
                        target="_blank"
                        rel="noreferrer">
                        <DetailContainerText>
                          4th-7th Floor, 50, Chowringee Rd, Elgin, Kolkata, West Bengal 700071
                        </DetailContainerText>
                      </a>
                    </DetailContainer>
                  </AccordionDetailsDiv>
                ...
                <AccordionDiv
                  ...
                  onChange={handleChangeAccordin('panel3-header')}
                  sx={{
                    '&:before': {
                      backgroundColor: '#DA7A7A', // Change this to the desired color
                    },
                  ...
                  <AccordionDetailsDiv>
                    <DetailContainer>
                      ...
                      />
                      <a
                        href="https://maps.app.goo.gl/2aujydXLkFMt4CBk6"
                        style={{ color: '#ffffff', textDecoration: 'none' }}
                        target="_blank"
                        rel="noreferrer">
                        <DetailContainerText>
                          Club house,Gran Carmen,Sarjapur Road ,Near Belenus Champion hospital,Bengaluru -560035
                        </DetailContainerText>
                      </a>
                    </DetailContainer>
                  </AccordionDetailsDiv>
